...
import com.zyp.weixinsell.repository.OrderDetailReposity;
import com.zyp.weixinsell.repository.OrderMasterReposity;
import com.zyp.weixinsell.service.IOrderService;
import com.zyp.weixinsell.service.IProductService;
import com.zyp.weixinsell.service.WebSocket;
import com.zyp.weixinsell.util.GenerateKeyUtil;
import com.zyp.weixinsell.util.OrderMaster2OrderDTO;
...
public class OrderServiceImpl implements IOrderService {
  ...
  // @Transactional事务回滚
    @Override
    @Transactional
    public OrderDTO create(OrderDTO orderDTO) {  //根据商品id买
        // 获取随机订单Id
